      ...
      void td(int l) {
         ...
         } else
         {
            ...
            if (!(fields[f].flags & NOT_NULL_FLAG))
            {
               ...
               printf(" onchange='document.getElementById(\"E%d\").disabled=!this.checked;if(this.checked)document.getElementById(\"E%d\").focus();'", f, f);
               printf("/>");
            }
            if (q->elist)
            {
