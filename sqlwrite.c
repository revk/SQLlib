      ...
      while ((row = sql_fetch_row (res)))
      {
         ...
         {                      // unique key
            ...
            if (isdigit (e[0]) && isdigit (e[1]) && e[2] == '/'
                && isdigit (e[3]) && isdigit (e[4]) && e[5] == '/'
                && isdigit (e[6]) && isdigit (e[7]) && isdigit (e[8])
                && isdigit (e[9]) && (!e[10]
                                      || (isspace (e[10]) && isdigit (e[11])
                                          && isdigit (e[12]) && e[13] == ':'
                                          && isdigit (e[14])
      ...
      if (n < valuen || (!onlylisted && e))
      {
         ...
         } else
         {
            if ((field[f].type == FIELD_TYPE_DATE || field[f].type == MYSQL_TYPE_NEWDATE
                ...
                && isdigit (e[4]) && e[5] == '/' && isdigit (e[6])
                && isdigit (e[7]) && isdigit (e[8]) && isdigit (e[9])
                && (!e[10]
                    || (isspace (e[10]) && isdigit (e[11])
                        && isdigit (e[12]) && e[13] == ':'
                        && isdigit (e[14]) && isdigit (e[15]) && e[16] == ':' && isdigit (e[17]) && isdigit (e[18]) && !e[19])))
            {                   // funny date format
               sql_sprintf (&query, "'%.4s-%.2s-%.2s", e + 6, e + 3, e + 0);
               while (*e && (isdigit (*e) || *e == ':' || *e == ' '))
                  sql_sprintf (&query, "%c", *e++);
               sql_sprintf (&query, "'");
            } else if (!*e && (field[f].type == FIELD_TYPE_DATE || field[f].type == MYSQL_TYPE_NEWDATE
                               || field[f].type == FIELD_TYPE_TIMESTAMP || field[f].type == FIELD_TYPE_DATETIME))
